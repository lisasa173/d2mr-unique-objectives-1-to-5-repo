...
abstract: "This document presents visualization of several graphs to demonstrate my ability using ggplot."
...
```{r}
#| label: mean, median, & sd of miles per gallon for each cylinder type
#| echo: TRUE
library(knitr)
...
```{r}
#| label: frequency and proportion of engine being v-shaped (=0) vs. straight (=1)
#| echo: TRUE

mtcars.viz %>% tabyl (engine) %>%
  kable(digits = 2, caption = "Summary Statistics for Engine")
...
ggsave("scatterplot.png", dpi = 300, width = 7, height = 5)
...
#| fig-cap: "Figure 6: Stacked barplot of frequency by weight class categorized by automatic or manual transmission type"
#| echo: TRUE
