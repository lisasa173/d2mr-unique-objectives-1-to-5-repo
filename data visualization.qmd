...
```{r Graph Descriptive Analysis 1, echo = FALSE}
...
```{r Graph Descriptive Data Analysis 2, echo = FALSE}
...
```{r Faceted Scatterplot, echo = FALSE}
...
```{r Compare results example, echo = FALSE}
...
```{r Does weight predict mpg? Does having v-shaped or straight engine change this prediction?, echo = FALSE}
