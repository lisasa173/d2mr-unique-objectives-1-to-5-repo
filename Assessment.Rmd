...
Mini-project title: data visualization.qmd

Submission date: 2/18/2025

Project GitHub subdirectory URL: 
https://github.com/lisasa173/d2mr-unique-objectives-1-to-5-repo

URL or instructions to access additional materials, if needed:
This new repo contains the data visualization project aiming to meet visualization & RStudio & GitHub objectives. The viz-level-1.qmd is not the actual document I worked on. Please navigate to the following website to see the complete project: https://github.com/lisasa173/d2mr-unique-objectives-1-to-5-repo. The objectives 1 to 5 repo contains the gitignore, readme, and data visualization.qmd that aim for objectives 1-5 and beyond. The current subdirectory only has the Assessment.Rmd file that contains valid information.
...
1. Did you complete the project with direct collaborators or general support? If so, who did you collaborate with and what was/were their contribution(s)?
    1. Direct collaborators (students who will be turning in a version of the same project) and their contributions: I completed this on my own.
    2. General support (students who helped you with debugging, conceptual understanding, or the like) and their contributions:
    My TA kindly supported me by clarifying the objectives I haven't met and how to meet the yet unmet objectives.
2. Did you use LLMs or other AI models to generate text or code for this project? If so, which tools did you use and how did you use them? Remember in this class you *are* allowed (even encouraged) to use these tools for help with coding, but not for writing text. This can be very brief, just one or two sentences is fine unless you have more you'd like to add.
    1. I searched how to sort frequency from lowest to highest or highest to lowest on chatgpt, but wrote the code by myself.
...
*Note: I think I met this in the "Class_output.R" script.
...
*Note: I think I met this both in the "Class_output.R" script and in the data visualization.qmd.
...
*Note: I completed 4 in lines 104-105 in data visualization.qmd.
        -   [ ] Objective attempt
        -   [*] Unique objective attempt
        -   [ ] Objective met
        -   Grader comments:
...
I think I've met objectives 4, 10, 12, 13, 15, & 16 in this mini-assignment. 

For 4: please refer to lines 7 & 81.
For 10: I created "Class_output.R" separately and sourced it rather than embedding it inside the .qmd because I think that function was not directly relevant the task of graphing a stacked plot.
For 12: I can differentiate between numeric and non-numeric data. 
For 13: please refer to lines 208-221 vs. lines 236-247. I differentiated a categorical variable from a continuous variable.
For 15: I can recognize histogram, barplot, scatterplots with regression lines, and create graphs by the interpretations I need (e.g., compare the means of MPG by cylinder type). 
For 16: I know what graph to draw for the specific question (e.g., "What are corresponding levels of MPG when the car has 4, 6, or 8 cylinders?" & "How to compare the proportion of engine?" (i.e., Graph Descriptive Data Analysis 2)).
...
I learnt to visualize descriptive data, to use appropriate graphs for a specific question, to make the graphs look beautiful, and to use APA style to render graphs. I also tried out ggsave() and knitr::include_graphics() to see how to save the plots and how to compare the plots under one code chunk. Moreover, I tried a linear regression model in plot 7, and learnt that linear regressions can be directly plotted through ggplot() functions, in addition to being separately defined, although I suspect that for more difficult regressions I need to separately define them before plotting into the graph. Moreover, I learnt how to output a apaquarto pdf, how to use fig-cap & label: tbl or label: fig to allow apaquarto to automatically generate sequence starting from figure 1. I also learnt how to create visually beautiful tables and figures, using theme() and kable(). Moreover, I actually just learned in this project how to commit & push from the terminal.
