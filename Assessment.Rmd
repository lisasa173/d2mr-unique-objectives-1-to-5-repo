...
Mini-project title: viz-level-1.qmd (Data visualization)
...
This new repo contains the data visualization project aiming to meet visualization objectives. By creating this new repo I aim to meet objectives 1-5 (Rstudio & github) & some R markdown & Quarto objectives.
...
I think I've met objectives 12, 15, & 16 in this mini-assignment. For 12, I can differentiate between numeric and non-numeric data. For 15, I can recognize histogram, barplot, scatterplots with regression lines, and create graphs by the interpretations I need (e.g., compare the means of MPG by cylinder type). For 16, I know what graph to draw for the specific question (e.g., What are corresponding levels of MPG when the car has 4, 6, or 8 cylinders?).
...
I learnt to visualize descriptive data, to use appropriate graphs for a specific question, to make the graphs look beautiful, and to use APA style to render graphs.
